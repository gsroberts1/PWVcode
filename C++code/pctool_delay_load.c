 ...
 */
FARPROC WINAPI pctoolDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = pctoolDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = pctoolDelayLoadWin32FailureHook;
#endif
